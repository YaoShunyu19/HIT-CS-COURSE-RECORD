...
public class GA1 implements GA{
	...
	public GA1(TSPproblem tp,int pop_size,int gen_size,double p_cross,double p_mutate) {
		this.tp=tp;
	...
	public void run() {
		...
		for (int i=0;i<gen_size;i++) {
			...
			//锦标赛选择算法
			pop=Selection.tournamentSelection(this,pop,this.pop_size,(int)Math.sqrt(pop_size));
