...
public class GA3 implements GA{
	...
	public GA3(TSPproblem tp,int pop_size,int gen_size,double p_cross,double p_mutate) {
		this.tp=tp;
	...
	public void run() {
		...
		for (int i=0;i<gen_size;i++) {
			...
			//精英选择算法
			pop=Selection.elitismSelection(this,pop,this.pop_size);
